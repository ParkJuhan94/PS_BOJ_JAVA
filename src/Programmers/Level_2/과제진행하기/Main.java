...
public class Main {
    ...
    public static void main(String[] args) {
        String[][] plans1 = {{"korean", "11:40", "30"},
                            {"english", "12:10", "20"},
                            {"math", "12:30", "40"}};
        String[] result1 = s.solution(plans1);
        ...
        String[][] plans2 = {{"science", "12:40", "50"},
                            {"music", "12:20", "40"},
                            {"history", "14:00", "30"},
                            {"computer", "12:30", "100"}};
        String[] result2 = s.solution(plans2);
        ...
        String[][] plans3 = {{"aaa", "12:00", "20"},
                            {"bbb", "12:10", "30"},
                            {"ccc", "12:40", "10"}};
        String[] result3 = s.solution(plans3);
